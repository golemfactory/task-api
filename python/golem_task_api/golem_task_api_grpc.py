...
import golem_task_api.golem_task_api_pb2
    ...
    def __mapping__(self):
        return {
            '/golem_task_api.GolemApp/CreateTask': grpclib.const.Handler(
                ...
                golem_task_api.golem_task_api_pb2.CreateTaskRequest,
                golem_task_api.golem_task_api_pb2.CreateTaskReply,
            ),
            '/golem_task_api.GolemApp/NextSubtask': grpclib.const.Handler(
                self.NextSubtask,
                grpclib.const.Cardinality.UNARY_UNARY,
                golem_task_api.golem_task_api_pb2.NextSubtaskRequest,
                golem_task_api.golem_task_api_pb2.NextSubtaskReply,
            ),
            '/golem_task_api.GolemApp/Compute': grpclib.const.Handler(
                self.Compute,
                grpclib.const.Cardinality.UNARY_UNARY,
                golem_task_api.golem_task_api_pb2.ComputeRequest,
                golem_task_api.golem_task_api_pb2.ComputeReply,
            ),
            '/golem_task_api.GolemApp/Verify': grpclib.const.Handler(
                self.Verify,
                grpclib.const.Cardinality.UNARY_UNARY,
                golem_task_api.golem_task_api_pb2.VerifyRequest,
                golem_task_api.golem_task_api_pb2.VerifyReply,
            ),
            '/golem_task_api.GolemApp/RunBenchmark': grpclib.const.Handler(
                self.RunBenchmark,
                grpclib.const.Cardinality.UNARY_UNARY,
                golem_task_api.golem_task_api_pb2.RunBenchmarkRequest,
                golem_task_api.golem_task_api_pb2.RunBenchmarkReply,
            ),
        }
